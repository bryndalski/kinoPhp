...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="scss/css/styles.css" />    <script defer src="js/scriptRegister.js"></script>
  </head>
  <body class="--hidden">
    <div
    ...
    >
      ...
      <form  method="POST" class="flex flex--between flex--col">
          ...
          <div class="flex flex--row flex--between inputGroup">
            <input class="m--1" name="phone"  id="phone" type="number" placeholder="Phone number"require />
          </div>
          <div class="flex flex--row flex--between inputGroup">
            <input
              class="m--1"
          ...
          <button name="register" id="sub"  class="m--center button button--accept">Register</button>
        </form>
        <?php if (
            isset($_POST["login"]) &&
            isset($_POST["login"]) != "" &&
            ...
            if ($result->num_rows > 0) {
                ...
                if (
                    ...
                    echo "Użytkownik dodany: zaloguj się {$_POST["login"]}";
                }
            }
            $conn->close();
        } ?>
